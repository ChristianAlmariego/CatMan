...
call F:\IBM\WCDE80\bin\dataextract %CURRDIR%/wc-dataextract-sales.xml -DlogFilePath=%CURRDIR%/wc-dataextract-sales-emr.log -DstoreIdentifier=EMR -DcatalogIdentifier=EMR_SALES_CATALOG -DoutputLocation=salescatalog-emr
