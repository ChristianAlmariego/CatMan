    ...
    AND catgpenrel.catgroup_id
        ...
        (
            ...
            ( 
                ...
                catgroup_id_parent IN (select catgroup_id from catgroup where identifier IN ('M-Commercial-Residential-Solutions')) connect by prior 
            ...
            UNION 
                select catgroup.catgroup_id from catgroup 
                    where catgroup_id IN (select catgroup_id from catgroup where identifier IN ('M-Commercial-Residential-Solutions'))
        )
